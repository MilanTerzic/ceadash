...
export const Route = createFileRoute("/dashboard/weather")({
  head: () => ({ meta: [{ title: "Weather — CEA Power Dashboard" }] }),
...
function WeatherPage() {
  ...
  return (
    <>
      <TopBar
        title="Weather"
        subtitle="Open-Meteo · Visual Crossing fallback · capital city forecasts"
        onRefresh={() => q.refetch()}
      />
          ...
          actions={
            <div className="flex items-center gap-2 text-[10px] text-muted-foreground">
              ...
              <span
                ...
                style={{
                  background:
                    "linear-gradient(90deg, oklch(0.62 0.18 240), oklch(0.62 0.18 120), oklch(0.62 0.18 0))",
                }}
              />
              <span>+40°</span>
            </div>
          ...
          <table className="w-full text-sm">
            <thead className="text-[10px] uppercase tracking-wider text-muted-foreground">
              <tr>
                ...
                <th className="text-right">Avg °C</th>
                <th className="text-right">Max °C</th>
                <th className="text-right">Avg wind m/s</th>
                <th>Demand signal</th>
                <th></th>
              </tr>
            </thead>
